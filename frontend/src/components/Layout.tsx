    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-gradient-to-br from-background via-background to-accent/5">
        ...
        <div className="flex-1 flex flex-col">
          <header className="h-16 border-b border-border/40 bg-background/80 backdrop-blur-xl flex items-center justify-between px-6">
            <div className="flex items-center gap-6">
              ...
              <div className="relative max-w-md hidden sm:block">
                ...
                <Input 
                  ...
                  className="pl-10 bg-background/50 border-border/60 rounded-xl h-10"
                />
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              <Button 
                ...
                size="icon" 
                onClick={toggleTheme}
                className="rounded-xl h-10 w-10 hover:bg-accent/50"
              >
                {theme === 'dark' ? <Sun className="h-5 w-5" /> : <Moon className="h-5 w-5" />}
              </Button>
              <Button variant="ghost" size="icon" className="rounded-xl h-10 w-10 hover:bg-accent/50">
